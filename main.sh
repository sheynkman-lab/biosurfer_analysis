...
# Step 4 - Create toy dataset on biosurfer
    ...
    biosurfer load_db --source=GENCODE --gtf A_gencode_v42/biosurfer_gencode_v42_data/gencode.v42.basic.annotation.gtf --tx_fasta A_gencode_v42/biosurfer_gencode_v42_data/gencode.v42.pc_transcripts.fa --tl_fasta A_gencode_v42/biosurfer_gencode_v42_data/gencode.v42.pc_translations.fa -d wtc11
    biosurfer load_db --source=PacBio --gtf A_wtc11/biosurfer_wtc11_data/wtc11_with_cds.gtf --tx_fasta A_wtc11/biosurfer_wtc11_data/wtc11_corrected.fasta --tl_fasta A_wtc11/biosurfer_wtc11_data/wtc11_orf_refined.fasta --sqanti A_wtc11/biosurfer_wtc11_data/wtc11_classification.txt -d wtc11
...
# Step 5 - Run biosurfer hybrid alignment on the toy dataset
    ...
    biosurfer hybrid_alignment -d wtc11 -o B_hybrid_aln_wtc11_v42 
